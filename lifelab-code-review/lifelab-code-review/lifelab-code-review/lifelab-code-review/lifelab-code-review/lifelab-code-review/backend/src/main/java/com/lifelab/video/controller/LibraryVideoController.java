...
public class LibraryVideoController {
    ...
    public LibraryVideoController(
            LibraryVideoService libraryVideoService,
    ...
    public LibraryVideoResponse updateVideo(
        ...
        return libraryVideoService.updateVideo(
                currentAccount.requireAccountId(),
                id,
                request);
    }
    ...
    private void validateFilters(
        ...
        if (minDurationSeconds != null
            ...
            fieldErrors.putIfAbsent(
                    "minDurationSeconds",
                    "must be less than or equal to maxDurationSeconds");
            fieldErrors.putIfAbsent(
                    "maxDurationSeconds",
                    "must be greater than or equal to minDurationSeconds");
        }

        if (publishedFrom != null
                && publishedTo != null
                && publishedFrom.isAfter(publishedTo)) {
    ...
    private String validateSortBy(String sortBy) {
        ...
        if (!List.of(
                ...
                "lastWatchedAt")
                .contains(sortBy)) {
            throw new InvalidLibraryFilterException(
                    Map.of(
                            "sortBy",
                            "must be a supported sort field"));
        }
