...
public class TagService {
    ...
    private static final String TAG_NAME_UNIQUE_CONSTRAINT =
            "uk_tags_account_normalized_name";
    ...
    public TagResponse createTag(Long accountId, CreateTagRequest request) {
        ...
        if (tagRepository
                .findByAccount_IdAndNormalizedName(
                        accountId,
    ...
    public TagResponse renameTag(
        ...
        Tag tag = tagRepository
                .findByIdAndAccount_Id(tagId, accountId)
    ...
    @Transactional(readOnly = true)
    public List<TagResponse> getVideoTags(
            Long accountId,
            Long libraryVideoId) {
    ...
    public void attachTag(
        ...
        if (libraryVideoTagRepository
                .existsByLibraryVideo_IdAndTag_Id(libraryVideoId, tagId)) {
            return;
        }

        libraryVideoTagRepository.saveAndFlush(
                LibraryVideoTag.create(libraryVideo, tag));
    }
    ...
    public void detachTag(
        ...
        libraryVideoTagRepository.deleteByLibraryVideo_IdAndTag_Id(
                libraryVideoId,
                tagId);
    ...
    @Transactional(readOnly = true)
    public TagDeleteImpactResponse getDeleteImpact(
            Long accountId,
            Long tagId) {
    ...
    private LibraryVideo findOwnedLibraryVideo(
            Long accountId,
            Long libraryVideoId) {
        return libraryVideoRepository
    ...
    private NormalizedTagName normalize(String rawName) {
        String displayName =
                tagNameNormalizer.normalizeDisplayName(rawName);
    ...
    private record NormalizedTagName(
            String displayName,
