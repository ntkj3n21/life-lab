        ...
        <main className="flex min-h-screen items-center justify-center bg-(--app-bg) px-4 text-(--text-primary)">
          <div className="w-full max-w-md rounded-2xl border border-(--border) bg-(--surface) p-6 text-center">
            ...
            <button
              ...
              className="mt-5 rounded-xl bg-(--primary-bg) px-4 py-2 text-sm font-semibold text-(--primary-text) hover:bg-(--primary-hover) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--focus)"
            >
              Try again
            </button>
          </div>
